...
const Cart = () => {
  ...
  return (
    <div className="h-screen w-screen bg-gray-100 flex flex-col">
      {/* Navbar */}
      <nav className="flex justify-between items-center bg-blue-500 p-4 text-blue">
      ...
      <div className="flex-grow flex flex-col justify-center items-center overflow-y-auto p-6">
        {!checkoutDone ? (
          <>
